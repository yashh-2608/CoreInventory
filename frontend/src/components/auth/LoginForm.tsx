    ...
    <div className="w-full max-w-md mx-auto p-8 bg-white/5 border border-white/10 rounded-3xl backdrop-blur-xl shadow-2xl">
      ...
      <form className="space-y-5" onSubmit={handleSubmit}>
        ...
        <p className="text-center text-sm text-gray-400 pt-4">
          New to the platform? <button type="button" onClick={onToggleSignup} className="text-blue-400 hover:text-blue-300 font-bold underline decoration-blue-500/30 underline-offset-4">Create Account</button>
        </p>
      </form>
    </div>
  );
